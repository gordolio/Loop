...
struct ChatMessageBubbles_Previews: PreviewProvider {
    static var previews: some View {
        VStack(spacing: 16) {
            ...
            AssistantMessageBubble(text: "I've updated the rice to brown rice. The carb count is now slightly lower at 35g instead of 40g since brown rice has more fiber.")
