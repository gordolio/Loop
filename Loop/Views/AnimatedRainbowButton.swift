    ...
    var body: some View {
        Button(action: action) {
            ZStack {
                ...
                .foregroundColor(effectsOpacity > 0.01 && introGlow > 0.01 ? Color(hue: 0.70, saturation: 0.6 * introGlow * effectsOpacity, brightness: 0.5 + (0.3 * introGlow * effectsOpacity)) : .primary)
                .padding(.vertical, 12)
