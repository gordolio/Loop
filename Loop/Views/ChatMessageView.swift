...
struct ChatMessageView: View {
    ...
    var body: some View {
        ...
        case .carbSummary(let items, let canAccept):
            ChatCarbSummaryView(
                items: items,
                canAccept: canAccept,
    ...
    @ViewBuilder
    private func textMessageView(text: String, role: AIMessageRole) -> some View {
        switch role {
        case .user:
...
struct ChatMessageView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let sampleMessages: [AIConversationMessage] = [
            .assistantMessage("I've analyzed your food image. I see a turkey sandwich with cheese and an apple. The sandwich appears to be on regular white bread, about 2 slices."),
            ...
            .assistantMessage("Thanks for the correction! I've updated the sandwich to use low-carb bread, which significantly reduces the carb count.")
        ]
